...
if(isset($_POST['submit'])){
    ...
    // $check = $validate->emailExist($email);
    ...
    //use later
    // $validation = $validate->backEndValidation();
    $validation = $crud->checkEmail($email);
                if ($validation){
                    
                    var_dump($email . 'taken');exit;
                } else {
                    var_dump($email . 'Not taken');exit;
