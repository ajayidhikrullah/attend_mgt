    ...
    Class Query{
        ...
        public function runQuery(){
            try {
                ...
                // -- add fKey user_id to eventTB
                // "ALTER TABLE `events_tb` ADD CONSTRAINT `fk_event_user` FOREIGN KEY (`users_id`) REFERENCES `users`(`users_id`) ON DELETE RESTRICT ON UPDATE RESTRICT";
                //throw $th;
                return true;
